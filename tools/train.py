...
def main():
    ...
    if args.gpu_ids is not None:
        ...
        warnings.warn('`--gpu-ids` is deprecated, please use `--gpu-id`. '
                      ...
                      'in `gpu_ids` now.')
    if args.gpus is None and args.gpu_ids is None and 'gpu_ids' not in cfg:
    ...
    # set random seeds
    seed = init_random_seed(args.seed if args.seed else cfg.seed if 'seed' in cfg else 0, device=cfg.device)
