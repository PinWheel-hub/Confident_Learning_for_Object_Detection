...
optimizer = dict(type='SGD', lr=0.01 / 8 * 3, momentum=0.9, weight_decay=0.0001)
...
teacher_ckpt = 'my_configs/tyre_tood_config.py'
model = dict(
    type='KnowledgeDistillationSingleStageDetector',
    teacher_config='my_configs/tyre_tood_config.py',
    teacher_ckpt='checkpoints/tyre_tood_10.pth',
    backbone=dict(
        type='ResNet',
        depth=50,
        num_stages=4,
